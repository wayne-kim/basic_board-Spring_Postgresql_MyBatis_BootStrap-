				...
				<div class="box-body">
					<div class="input-group">
						...
						<span class="input-group-btn">
							...
							<a href="/board1/register" class="btn btn-success" id="newBtn">NEW BOARD</a>
						</span>
					</div>
				</div>
				<div class="box-body">
					<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="boardVO">
							<tr>
								<td>${boardVO.bno}</td>
								<td><a href="/board1/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}"> ${boardVO.title} </a></td>
